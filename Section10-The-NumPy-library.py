...
### Understanding Numpy Reshape(-1, 1) and Reshape(1, -1)

import numpy as np
#reshape(-1, 1)

#When you use reshape(-1, 1), you are asking numpy to reshape 
#your array with 1 column and as many rows as necessary 
#to accommodate the data. This operation will result in a 
#2D array with a shape (n, 1), where n is the number of 
...
#On the other hand, reshape(1, -1) reshapes your array 
#with 1 row and as many columns as necessary to accommodate
# the data. This operation will result in a 2D array with a 
#shape (1, n), where n is the number of elements in your 
#original array.
